...
(function(Global)
{
 ...
 ToDoListApp_Templates=Global.ToDoListApp_Templates=Global.ToDoListApp_Templates||{};
 ...
 SC$1=Global.StartupCode$ToDoListApp$Client=Global.StartupCode$ToDoListApp$Client||{};
 ...
 Client.Main=function()
 {
  ...
  _=(b=(t=(_this=(L=Doc.Convert(function(name)
  {
   ...
   return(b$1=(_this$2=new ProviderBuilder.New$1(),(_this$2.h.push(new Text.New("name",name)),_this$2)),(p$1=Handler.CompleteHoles(b$1.k,b$1.h,[]),(i$1=new TemplateInstance.New(p$1[1],ToDoListApp_Templates.listitem(p$1[0])),b$1.i=i$1,i$1))).get_Doc();
  ...
  },function()
  {
   ...
   newName.Set("");
  })),t)),(p=Handler.CompleteHoles(b.k,b.h,[["name",0,null]]),(i=new TemplateInstance.New(p[1],ToDoListApp_Templates.main(p[0])),b.i=i,i))).get_Doc();
 ...
 ToDoListApp_Templates.listitem=function(h)
 {
 ...
 ToDoListApp_Templates.main=function(h)
 {
  Templates.LoadLocalTemplates("index");
  return h?Templates.NamedTemplate("index",{
   $:1,
